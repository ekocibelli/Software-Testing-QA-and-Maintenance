...
def triangle_classification(a, b, c):
    """Function triangle_classification has three sides of a triangle as parameters and classifies the triangle
    if it is equilateral, scalene or isosceles and whether it is right triangle as well"""
    try:
